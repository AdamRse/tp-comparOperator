...
<div class="position-relative">
    ...
    <div class=" flex-column position-absolute end-0 top-0 align-items-center justify-content-center divPrincipal " >
        ...
        <div class="d-flex flex-column gap-3 planeteDetail" style="width: 100%; height:100%">
            ...
            <img src="" alt="" class="imgPlanet " style="max-width: 100%;">
        ...
        <!-- DIV INFOS TO -->
        <div class=" d-none flex-column overflow-hidden listeTO" style="width: 100%; height:100%">
        <div> 
            <button class="BackDescription btn text-white "><i class="fa-solid fa-arrow-right-from-bracket"></i></button>
        </div>
       <div class="listeTOs"></div>
    </div>
    </div>
</div>
