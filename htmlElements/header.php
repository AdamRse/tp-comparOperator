...
<header>
    <nav class="navbar bg-space-primary container border-bottom border-light">
        ...
        <div id="openConnect" class="text-space-primary-reverse fw-bold position-relative py-3 ps-3 me-5">
            ...
            <!-- icone guest -->
            <i data-menuid="formConnect" data-type="guest" class="<?= AUTHOR ? "d-none " : (TO ? "d-none " : "") ?>iconConnect fa-regular fa-user fa-lg text-space-primary-reverse ms-2 rounded-circle border-1 border-space-primary-reverse" style="cursor: pointer"></i>
            <!-- icone author -->
            ...
            <!-- icone TO -->
            <i data-menuid="divMenuTo" data-type="to" class="<?= AUTHOR ? "d-none " : (TO ? "" : "d-none ") ?>iconConnect fa-solid fa-user-tie fa-lg text-space-primary-reverse ms-2" style="cursor: pointer"></i>
